...
#define QUIC_ALLOC_PAGED_UNINITIALIZED(Size) ExAllocatePool2(POOL_FLAG_PAGED | POOL_FLAG_UNINITIALIZED, Size, QUIC_POOL_TAG)
#define QUIC_ALLOC_NONPAGED(Size) ExAllocatePool2(POOL_FLAG_NON_PAGED, Size, QUIC_POOL_TAG)
#define QUIC_ALLOC_NONPAGED_UNINITIALIZED(Size) ExAllocatePool2(POOL_FLAG_NON_PAGED | POOL_FLAG_UNINITIALIZED, Size, QUIC_POOL_TAG)
